...
class OverlayWindowServiceApi(
    ...
    override fun updateEnableDrag(overlayWindowId: String, enableDrag: Boolean) {
        val intent = Intent(_context, OverlayService::class.java)
        intent.action = "updateDragble";
        intent.putExtra(OverlayService.OVERLAY_WINDOW_DRAGBLE, enableDrag)
        intent.putExtra(OverlayService.OVERLAY_WINDOW_ID, overlayWindowId)
