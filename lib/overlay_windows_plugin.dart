...
class OverlayWindowsPlugin {
  ...
  Future<void> updateDragble(String overlayWindowId, bool updateDragbleValue) async {
    try {
      return await api.updateDragble(overlayWindowId, updateDragbleValue);
    } catch (e) {
      log('updateDragble error: $e');
    }
  }
